...
- Figma Design：[GP22](https://www.figma.com/design/MIUgoK0YUwDjTCJpGI6W1o/GP22?node-id=0-1)
...
Figma MCP 于 2026-08-01 完成只读核验：文件包含一个页面、一个 `1112 × 26001` 的顶层设计帧和 8,632 个后代节点，其中包括 3,557 个 Frame、2,652 个 Text、2,190 个 Vector 与 233 个 Group。
...
| `Visual Design Specification Plan.make` | 1,805,454 | `1BFAA51DF5FBE7B6EF69F10450BECCCEDC2797EE5ADB7236E1E938EF2ADEF807` | Make 容器：画布、缩略图、图片、AI 会话和二进制引用 |
...
上述哈希用于确认后续读取的是同一份人类批准交付物；文件内容发生变化时必须重新核验并记录新的设计决策。
