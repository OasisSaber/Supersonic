...
本仓库的最小单 Agent 工作流采用自 [TheMasterplan](https://github.com/OasisSaber/TheMasterplan) `v3.0.0`（完整模板采用，前身为 AgenticWonderwall）；采用记录见 [docs/development.md](docs/development.md)。
